...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_map_view_map_view__ = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__scan_property_scan_property__ = __webpack_require__(103);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_camera_preview__ = __webpack_require__(201);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__map_view_map_view__ = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_menus_menus__ = __webpack_require__(206);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_scan_property_scan_property__ = __webpack_require__(103);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_map_view_map_view__ = __webpack_require__(53);
...
var MapViewPage = /** @class */ (function () {
    function MapViewPage(navCtrl, navParams, geolocation) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.geolocation = geolocation;
        this.currentLocation = '';
    ...
    MapViewPage.prototype.ionViewDidLoad = function () {
        ...
        setInterval(function () {
            current.geolocation.getCurrentPosition()
                .then(function (location) {
                console.log(location);
                var lat = location.coords.latitude;
                var lng = location.coords.longitude;
                var position = { lat: lat, lng: lng };
                current.getCurrentLocation(lat, lng);
            });
        }, 2000);
    };
    MapViewPage.prototype.mapInit = function () {
